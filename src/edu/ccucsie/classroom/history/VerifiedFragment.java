...
public class VerifiedFragment extends ListFragment {
	...
	private static final String URI = "http://www.cs.ccu.edu.tw/~lht100u/classroom/app/verified.php";
	private static final String CANCEL_URI = "http://www.cs.ccu.edu.tw/~lht100u/classroom/app/cancel_verified.php";
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		mTextView = (TextView) view.findViewById(R.id.verifiedTextView);
	...
	public class MyAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if (convertView == null) {
				convertView = LayoutInflater.from(getActivity()).inflate(R.layout.listview_verified, null);
	...
	void updateListView() {
		if (mResult.length() != 0) {
			...
			mTextView.setText("您沒有任何已審核通過的借用記錄。");
			return;
		}
	...
	class SendCancelPostRunnable implements Runnable {
		...
		public void run() {
			String result = sendPostDataToInternet();
			mCancelHandler.obtainMessage(CANCEL_DATA, result).sendToTarget();
		}
